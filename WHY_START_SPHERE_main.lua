...
function love.load(arg)
    ...
    -- Load the text module and hand it the VibeMath binary directly
    Sequence.LoadModule("text", VibeMath, MainCamera)
    TextModule = Sequence.Loaded["text"]

    -- Now bake. The "lost time" will still happen, but at least
    -- the code is logically isolated.
